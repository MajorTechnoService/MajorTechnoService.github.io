...
var cookiePolicyURL = "/../../pages/cookie";
...
var buttonHandlerCss = 'padding: 1em; opacity:1; background-color: rgba(255,255,255,0.7); box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);';
...
function optInHandler(){
  ...
  setTimeout(readUserInput, 1500); // aspetta 1.5 secondi per dar tempo all'utente di notare il banner
}
